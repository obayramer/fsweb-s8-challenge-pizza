...
export default function BottomIcons() {
  ...
  const icons = [
    { path: "./Iteration-2-assets/icons/1.svg", val: "YENİ! Kore" },
    { path: "./Iteration-2-assets/icons/2.svg", val: "Pizza" },
    { path: "./Iteration-2-assets/icons/3.svg", val: "Burger" },
    { path: "./Iteration-2-assets/icons/4.svg", val: "Kızartmalar" },
    { path: "./Iteration-2-assets/icons/5.svg", val: "Fast Food" },
    { path: "./Iteration-2-assets/icons/6.svg", val: "Gazlı İçecekler" },
  ];
  const handleClick = () => {
